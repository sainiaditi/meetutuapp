package com.example.android.meetutuapp;
...
import static com.example.android.meetutuapp.R.id.email;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private EditText mIwanttolearn;
    private EditText mIcanteach;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIcanteach = (EditText) findViewById(R.id.icanteach);

        mIwanttolearn = (EditText) findViewById(R.id.iwanttolearn);
    ...
    private void attemptLogin() {
        ...
        String icanteach = mIcanteach.getText().toString();
        String iwanttolearn = mIwanttolearn.getText().toString();
        ...
        if(TextUtils.isEmpty(phone)){
            ...
            mPhoneNoView.setError("Enter 10 digit mobile number");
            focusView = mPhoneNoView;
            cancel = true;
        }
